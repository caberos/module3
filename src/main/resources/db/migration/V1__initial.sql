...
insert into users (users_id, created_at, email, password, username) values
...
insert into user_detail (user_detail_id, age, birthday, first_name, last_name, user_id) values
